var myFonts = {
    taamey_frank_clm: "css/woff2/TaameyFrankCLM.woff2",
    pft_sivan: "css/woff/pft_sivan-webfont.woff",
    stamsefaradclm: "css/woff/stamsefaradclm-webfont.woff",
    eft_stamsefarad: "css/woff/eft_stam_sfaradi-webfont.woff",
    pft_stam: "css/woff/pft_stam-webfont.woff",
    pft_vilna: "css/woff/pft_vilna-webfont.woff",
    eft_besimches: "css/woff/eft_besimches-webfont.woff",
    eft_frankfurt: "css/woff/eft_frankfurt-webfont.woff",
    pft_ktav: "css/woff/pft_ktav-webfont.woff",
};

//eft_frankfurt-webfont.woff
//myFonts.id3 = 400;
//myFonts["id4"] = 500;

// Loading FontFaces via JavaScript is alternative to using CSS's @font-face rule.
for (var key in myFonts) {
    console.log("key " + key + " has value " + myFonts[key]);
    var f = new FontFace(key, "url(" + myFonts[key] + ")");
