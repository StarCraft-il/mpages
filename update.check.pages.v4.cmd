...
# Folder-card background colors. Any valid CSS color value can be used here.
# Folders in TopFolderNames, including their subfolders, use the first color.
$script:TopFolderCardBackgroundColor = 'rgba(14, 116, 144, 0.35)'
$script:OtherFolderCardBackgroundColor = 'rgba(18, 28, 45, 0.82)'
...
<head>
    ...
    <style>
        :root {
            ...
            --muted: #9eb0ca;
            --accent: #38bdf8;
            --top-folder-background: __TOP_FOLDER_BACKGROUND_COLOR__;
            --other-folder-background: __OTHER_FOLDER_BACKGROUND_COLOR__;
        }
...
function Update-CheckPagesFile {
    ...
    $content = $template.
        ...
        Replace('__TOP_FOLDER_BACKGROUND_COLOR__', $script:TopFolderCardBackgroundColor).
        Replace('__OTHER_FOLDER_BACKGROUND_COLOR__', $script:OtherFolderCardBackgroundColor).
